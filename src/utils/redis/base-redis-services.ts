...
export type TRedisKeyPart = string | number | ObjectId;

export class BaseRedisCache<TKey = TRedisKeyPart, TValue = string | number | ObjectId> {
	constructor(
